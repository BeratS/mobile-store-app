...
export default function AIScreen() {
  const [messages, setMessages] = useState([
    { id: 1, role: 'assistant', text: "Hi Alex! I can help you secure a hotdesk near your team or manage your schedule today. What's on your mind?" }
  ]);
  ...
  return (
    <View className="flex-1 bg-white dark:bg-darkBg px-6 pt-12 pb-4">
      {/* Header Container */}
