...
export default function Dashboard() {
  ...
  return (
    <View className="flex-1 bg-white dark:bg-darkBg p-6">
      <ScrollView className="flex-1 bg-white dark:bg-darkBg">
        {/* Header */}
        ...
        <TouchableOpacity
          ...
          className="mb-8 p-4 pl-8 pr-6 rounded-full border border-primary dark:border-white flex-row items-center justify-between"
        >
            <Text className="text-primary dark:text-lightText font-bold text-base">Book a Spot</Text>
          <IconSymbol name="chevron.right" size={20} className="text-primary dark:text-lightText" />
        </TouchableOpacity>
