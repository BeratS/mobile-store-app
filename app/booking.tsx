...
export default function BookingScreen() {
  ...
  return (
    <View className="flex-1 bg-white dark:bg-darkBg p-6">
      <Text className="text-slate-900 dark:text-lightText text-2xl font-bold">Reservations</Text>
      <Text className="text-slate-500 dark:text-mutedText text-xs mt-1 mb-6">You can use this page to reserve a desk or parking space.</Text>
